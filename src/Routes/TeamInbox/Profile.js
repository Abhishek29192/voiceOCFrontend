            ...
            <div>
                <div className='flex items-center justify-between py-5 p-2 border-b-2 bg-slate-200'>
                    <div className='flex items-center'>
                        ...
                        <div>
                            <Base2 className='text-2xl poppins'>{profileData.firstName}</Base2>
                    ...
                    <div className='flex items-center'>
                        <div className='flex items-center'>
                            <div>
                                <SecondaryButton text={"Sign Out"} type={"button"} onClick={handleSignOut} />
                            </div>
                            <div className="border-[black] border-[2px] rounded-full mx-3">
                                <RxCross2 size={"1.5rem"} onClick={() => setOpenProfile(false)} />
                            </div>
                        </div>
                    </div>
                </div>
