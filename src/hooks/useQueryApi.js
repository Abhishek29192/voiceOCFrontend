...
//PostOtp
export const usePostForgetOtp = () => {
  return useMutation({
    mutationKey: ["forgot-otp"],
    mutationFn: async (data) => {
      // console.log(data, "datatatatataa")
      return PostOtp(data);
    },
...
// deleteContactExcel
//sortBroadcastDateRange
export const useSortDateRangeFilter = () => {
  return useMutation({
    mutationKey: ["date-range-filter"],
    mutationFn: async (data) => {
      return sortBroadcastDateRange
        (data);
    },
    onError: (e) => e,
  });
...
export const useDeleteContactExcel = () => {
  return useMutation({
    mutationKey: ["delete-excel"],
    mutationFn: async (data) => {
      return deleteContactExcel(data);
    },
    onError: (e) => e,
  });
};
